...
class Tracer:
    ...
    def init(cls, service_name=None, api_key=None, collector_url=None):
        ...
        collector_url = collector_url or os.environ.get("TRACER_COLLECTOR_URL", "http://localhost:4317")
...
from .integrations.logging import TracerHandler
from .integrations.http import patch_all, patch_requests, patch_httpx

__all__ = ['Tracer', 'TracerHandler', 'patch_all', 'patch_requests', 'patch_httpx']
