...
public class TraceFlowFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        // Extract incoming trace context (from upstream service via Feign)
        String incomingTraceId = request.getHeader(TraceContext.TRACE_ID_HEADER);
        String parentSpanId    = request.getHeader(TraceContext.SPAN_ID_HEADER);
            ...
            try {
                ...
                if (props.isCaptureHttpBody()) {
                    ...
                    if (reqBody.length > 0) {
                        ...
                        attrs.put("http.body",         truncate(new String(reqBody, StandardCharsets.UTF_8)));
                    ...
                    if (resBody.length > 0) {
                        ...
                        attrs.put("http.body",   truncate(new String(resBody, StandardCharsets.UTF_8)));
